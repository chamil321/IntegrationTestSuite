 ...
 */
public class RetrySampleTestCase {

    private static final int servicePort = 9105;
    private static final int statusCodeServicePort = 9225;
    private static final String RETRY_HEADER = "x-retry";

    public static void testSimpleRetry() throws IOException {
    ...
    public static void testMultiPart() throws IOException {
    ...
    public static void testNestedMultiPart() throws IOException {
        String multipartDataBoundary = Long.toHexString(PlatformDependent.threadLocalRandom().nextLong());
    ...
    public static void testRetryBasedOnHttpStatusCodes() throws IOException {
        Map<String, String> headers = new HashMap<>();
    ...
    public static void testRetryBasedOnHttpStatusCodesContinuousFailure() throws IOException {
        Map<String, String> headers = new HashMap<>();
