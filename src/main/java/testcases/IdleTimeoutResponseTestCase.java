...
public class IdleTimeoutResponseTestCase {
    ...
    private static final int servicePort = 9112;

    public static void test408Response() throws IOException, InterruptedException {
    ...
    public static void test500Response() throws Exception {
